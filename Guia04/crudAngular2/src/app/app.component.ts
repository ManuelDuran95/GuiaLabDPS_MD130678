...
alumnoArray: Alumno[] = [
  {id:1, name:"Alex", lastname:"Campos",age:35,direccion:"Ahuachapan",tel:24138956,email:"correo@server.com"},
  {id:2, name:"Maria",lastname:"Lopez",age:20,direccion:"Santa Ana",tel:24138963,email:"correo2@server.com"},
  {id:3, name:"Juan", lastname:"Castro",age:25,direccion:"Ahuachapan",tel:24174956,email:"correo3@server.com"}
]
//atributo selecAlumno del tipo Alumno, por lo tanto, puede almacenar un objeto
selectedAlumno: Alumno = {id:0, name:'', lastname:'', age:0,direccion:'',tel:0,email:'' };
...
this.selectedAlumno = {id:0, name: '', lastname: '', age:0,direccion:'',tel:0,email:''  };
}
